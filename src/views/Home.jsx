    ...
    return (
      <React.Fragment>
        ...
        <div className="container-fluid bg-light mb-3">
          <div className="row">
            <div className="col-md-12">
              <CardDealsOfTheDay
                endDate={Date.now() + 1200 * 120 * 120 * 14}
        ...
        <div className="container">
          <div className="row ml-98">
            <div className="col-md-3">
              <Link to="/" className="text-decoration-none">
                <img
                width="120px"
                height="120px"
                  src="../../images/category/shirt.png"
                  className="img-fluid rounded-circle "
                  alt="..."
                />
                <div style={{paddingRight:"148px"}} className="text-center h6 " >Men's Clothing</div>
              </Link>
            </div>
            <div className="col-md-3">
              <Link to="/" className="text-decoration-none">
                ...
                height="120px"
                  ...
                  alt="..."
                />
                <div style={{paddingRight: "148px", paddingTop: "15px"}} className="text-center h6">Women's Clothing</div>
              </Link>
            </div>
            <div className="col-md-3">
              <Link to="/" className="text-decoration-none">
                ...
                height="120px"
                  ...
                  alt="..."
                />
                <div style={{paddingRight: "148px", paddingTop: "30px"}} className="text-center h6">Smartwatch</div>
              </Link>
            </div>
            <div className="col-md-3">
              <Link to="/" className="text-decoration-none">
                ...
                width="120px"
                height="120px"
                  src="../../images/category/shoes.jpeg"
                  className="img-fluid rounded-circle"
                  alt="..."
                />
                <div style={{paddingRight: "148px", paddingTop: "30px"}} className="text-center h6">Brand Shoes</div>
              </Link>
            </div>
          </div>
        </div>
